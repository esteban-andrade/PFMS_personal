...
const double DEFAULT_CELL_SIZE = 0.1; /*!< Default cell size [m]*/ //0.1

/**
@class Cell
@brief Cell will be used as areas of space (rectangles) where the sensor data will be fused to indicate occupancy, default size provided, centre location draw randonly from a map of max size. On creation state is UNKNOWN
