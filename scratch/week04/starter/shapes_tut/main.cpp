...
double computeTotalArea(std::vector<Shape *> vec);
int main()
{
    ...
    generatedShapes.push_back(new Circle(5.0));
    generatedShapes.push_back(new Circle(15.0));
    generatedShapes.push_back(new Circle(25.0));
    generatedShapes.push_back(new Rectangle(5, 10));
    generatedShapes.push_back(new Rectangle(5, 5));
    generatedShapes.push_back(new Triangle(5.0, 3.0));
    generatedShapes.push_back(new Triangle(10, 5.0));
    double total_area = 0;
    displayArea(generatedShapes);
    for (auto shape : generatedShapes)
    {
...
double computeTotalArea(vector<Shape *> vec)
{
    double total_area = 0;
    for (auto circle : vec)
    {
