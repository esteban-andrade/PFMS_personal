...
void DataProcessing::processSamples() {
    while (true) {
        ...
        //!
        //! pred
        //! A callable object or function that takes no arguments and returns a value that
        //! can be evaluated as a bool.  This is called repeatedly until it evaluates to true.
        cv.wait(lck,!data.empty());

        //! Or we can use a lambda function, the syntax for is [&] and then a function in {}
