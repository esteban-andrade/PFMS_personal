...
// Ex05. Returns a bool value if the double is greater than zero
...
// Ex06. Returns bool value if the double is greater than zero, the square value, the cube value and the passed value incremented by one
